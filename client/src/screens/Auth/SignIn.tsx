...
import { ScrollView, Text, View, KeyboardAvoidingView, TouchableOpacity, Platform } from "react-native"
      ...
      <ScrollView className="flex-grow min-h-full pb-5">
        <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : undefined}>
          ...
          <TouchableOpacity
            ...
            className="bg-white border border-secondary w-[70%] mx-auto rounded-full py-3 h-[50px] justify-center items-center mt-8 mb-8"
          >
